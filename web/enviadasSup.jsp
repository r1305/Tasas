...
<html>
    ...
    <center>
        <div class="panel panel-default" style="width: 35%;height: 63%;margin-top: 1px"> 
            <!--con el c:forEach hacemos el recorrido de todas las filas que devuelve el query-->
            <c:forEach var="row" items="${result.rows}">
                <table align='center' style="width: 98%;margin-top: 15px">
                    <tbody>
                        <tr>
                            <td align='center' style="background-color: #00A94E;color: #ffffff" colspan="2">
                                <!--hipervinculo para volver a la bandeja de solicitudes-->
                                <button id="back" type="button" onclick="location.href = 'supervisor.jsp'"class="btn btn-default btn-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type='text' id='valorI' style="text-align: center" value="${row.Valor_inmueble}" readonly="">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Tasa ADQ</td>
                            <td><input class="form-control" readonly=""  type='text' id='adq' style="text-align: center" value="<fmt:formatNumber type="number" minFractionDigits="3" 
                                              maxFractionDigits="3" value="${row.Tasa_Solicitada}" /> %">
                                <input type="text" id="tasaS" readonly="true" hidden="" value="${row.Tasa_ADQ}">
                            </td>
                        </tr>
                        <tr>
                            <td>Tasa solicitada</td>
                            <td><input class="form-control" readonly="" type='text' id='tasaS' style="text-align: center" value="<fmt:formatNumber type="number" minFractionDigits="3" 
                                              maxFractionDigits="3" value="${row.Tasa_Solicitada}" /> %">
