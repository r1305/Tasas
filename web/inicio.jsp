...
<html>
    ...
    <c:forEach var="row" items="${result.rows}">
        <center>
            <div class="panel panel-default" style="width: 30%;margin-top: 1px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align='center' style="background-color: #00A94E;color: #ffffff" colspan="2">
                                ...
                                <b style="margin-left: -80px">Calculadora de TASA</b>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="tasaS" readonly="true" class="form-control" value="${row.Tasa_Solicitada}">
                            </td>
                        </tr>  
                        <tr>
                            <td style="vertical-align:middle;font-size: 14px">
        ...
        <!-- Boton para descargar archivos adjuntos -->
