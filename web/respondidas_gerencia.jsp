...
<html>
    ...
    <c:forEach var="row" items="${result.rows}">
        <center><div class="panel panel-default" style="width: 400px;margin-top: 1px">
                ...
                <table style="width: 400px"align='center'>
                    <tbody>
                        ...
                        <tr>
                            <td align='center' style="background-color: #00A94E;color: #ffffff" colspan="2">
                                <button id="back" type="button" onclick="location.href = 'gerente.jsp'"class="btn btn-default btn-sm">
                    ...
                    <tr>
                        <td style="vertical-align:middle;font-size: 14px">Comentarios</td>
                        <td><textarea type="text" id="comentario" name="comentario" value="${row.Comentarios}" class="form-control" maxlength="255" readonly=""></textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
