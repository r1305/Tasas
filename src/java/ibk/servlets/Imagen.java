...
public class Imagen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ruta=request.getParameter("archivo");*/
        String id = request.getParameter("idA");
        ...
        if (file.getSize() > 0) {
            ...
            writer.println("getFileName " + getFileName(file));
            writer.println("New file " + file);
            writer.println("New file " + writeFile(file));
            writer.println("En BD " + con.insertFiles(writeFile(file), id));*/
        } else {
            //con.insertFiles(writeFile(file), id);
